...
function preload(){
  database=firebase.database();
   ...
   balloonImage1=loadAnimation("hotairballoon1.png"); balloonImage2=loadAnimation("hotairballoon1.png","hotairballoon1.png", "hotairballoon1.png","hotairballoon2.png","hotairballoon2.png","hotairballoon2.png","hotairballoon3.png","hotairballoon3.png","hotairballoon3.png");  
...
function draw() {
  ...
  function showError(){
    console.log("Wrror in writing database");
  }